...
export default function XpLogPage() {
  ...
  if (loading)
    return <div className="text-center text-slate-500">Loading Xp Log...</div>;
      ...
      <div className="border border-purple-300/20 rounded-lg overflow-hidden">
        ...
        <div className="grid grid-cols-4 bg-purple-950/60 px-6 py-6 text-sm font-medium text-slate-300">
          <div className="flex items-center gap-2">
            <ListChecks size={20} /> Type
          </div>
          <div className="flex items-center gap-2">
            <Flag size={20} /> Milestone
          </div>
          <div className="flex items-center gap-2">
            <Zap size={20} /> Amount
          </div>
          ...
          <div className="flex items-center gap-5">
            ...
            {pageNumbers.map((num) => (
              <button
                ...
                className={
                  num === currentPage
                    ? "border border-purple-500 bg-purple-400/10 rounded-[8] px-3 py-1 cursor-pointer"
                    : "text-slate-300 border border-purple-400/10 rounded-[8] px-3 py-1 cursor-pointer hover:bg-purple-400/20 transition-colors"
                }
              >
                {num}
              </button>
