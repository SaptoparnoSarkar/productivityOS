...
export default function MilestoneForm(props: Props) {
    ...
    const defaultValues = isEdit
        ...
        : { type: 'counter', title: '', description: '', weekly_minimum: undefined, daily_minimum: undefined, daily_minimum_unit: '' };
    ...
    return (
        <div className="form">
            <div className="form-header">
                ...
                <p className="form-subtitle">Create a milestone to track your progress.</p>
            </div>
                ...
                <FieldGroup>
                    <div className="fields">
                        ...
                        <div className="grid grid-cols-[2fr_1fr] gap-3">
                            <CustomInputs control={form.control} name='daily_minimum' type="number" label='Daily Minimum For XP' placeholder="Enter daily minimum" />
                            <CustomInputs control={form.control} name='daily_minimum_unit' label='Unit' placeholder="e.g: Chapters" />
                        </div>
                        <CustomInputs control={form.control} name='weekly_minimum' type="number" label='Weekly Minimum For XP' placeholder="e.g: 3" />
