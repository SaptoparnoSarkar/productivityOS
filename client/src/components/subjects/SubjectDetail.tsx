      ...
      <section className="detail-card">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-1.5 mb-15">
            <Link
              href={`${id}/edit`}
              className="text-white bg-blue-600 rounded p-2 w-20 flex gap-1 justify-center hover:bg-blue-700 transition duration-200"
            >
              <Edit2 /> Edit{" "}
            </Link>
            <button
              ...
              disabled={deleting}
              className="text-white bg-red-500 rounded p-2 flex gap-1 justify-center cursor-pointer hover:bg-red-600 transition duration-200"
            >
        ...
        <div className="flex justify-between items-center">
          ...
          <div>
            <Link
              ...
              className="border border-purple-500/50 rounded-[10] py-2 px-5 text-white hover:bg-white/10 transition-colors duration-200 flex items-center gap-2"
            >
